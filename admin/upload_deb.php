...
if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
    ...
    if (isset($_FILES['deb']['tmp_name'])) {
        ...
        if ($trang_ext[$trang_ext_c] != 'deb') {
            $error[] = 'Phải chọn file .DEB';
        }
        // Lỗi định dạng
        ...
        echo '<br/><div class="item"><font color="#800000">- Lỗi: Bấm <a>Quay lại</a> và chọn một file DEB!</font></div>';
    }
