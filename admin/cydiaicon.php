...
if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
    ...
    if (isset($_FILES['trangfile']['tmp_name'])) {
        ...
        if (!is_uploaded_file($_FILES['trangfile']['tmp_name'])) {
            $error[] = 'Bạn chưa chọn File ảnh';
        } elseif ($trang_ext[$trang_ext_c] != 'png') {
            $error[] = 'File ảnh phải có đuôi PNG';
        }
    ...
    if (file_exists('../CydiaIcon.png')) {
        echo '<center><img src="../CydiaIcon.png" /></center><br/><br/>';
    }
