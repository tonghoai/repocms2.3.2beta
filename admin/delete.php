...
if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
    ...
    if (empty($act)) {
        ...
        if (count($trang_f) == 0 || count($trang_d) == 0) {
            echo '<div class="alert alert-dismissible alert-success">Source của bạn đã sạch</div>';
        }
    ...
    echo '<div class="item"><font color="red">Lỗi: Bạn không có quyền vào trang này</font></div>';
}
